...
if [ -f "../models/stable-diffusion/sd-v1-4.ckpt" ]; then
    model_size=`wc -c "../models/stable-diffusion/sd-v1-4.ckpt" | cut -d ' ' -f1`
...
if [ -f "../models/gfpgan/GFPGANv1.3.pth" ]; then
    model_size=`wc -c "../models/gfpgan/GFPGANv1.3.pth" | cut -d ' ' -f1`
...
if [ -f "../models/realesrgan/RealESRGAN_x4plus.pth" ]; then
    model_size=`wc -c "../models/realesrgan/RealESRGAN_x4plus.pth" | cut -d ' ' -f1`
...
if [ -f "../models/realesrgan/RealESRGAN_x4plus_anime_6B.pth" ]; then
    model_size=`wc -c "../models/realesrgan/RealESRGAN_x4plus_anime_6B.pth" | cut -d ' ' -f1`
...
if [ -f "../models/vae/vae-ft-mse-840000-ema-pruned.ckpt" ]; then
    model_size=`wc -c "../models/vae/vae-ft-mse-840000-ema-pruned.ckpt" | cut -d ' ' -f1`
